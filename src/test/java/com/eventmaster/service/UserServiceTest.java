...
public class UserServiceTest {
    ...
    public void testSaveUserDuplicateUsername(){
        ...
        when(userRepository.save(user))
                .thenThrow(new DataIntegrityViolationException(
                        ...
                        " PUBLIC.USERS(USERNAME NULLS FIRST) VALUES ('testuser')\""));
    ...
    public void testSaveUserDuplicateEmail(){
        ...
        when(userRepository.save(user))
                .thenThrow(new DataIntegrityViolationException(
                        "Unique index or primary key violation: \"PUBLIC.CONSTRAINT_INDEX_4D ON" +
                        " PUBLIC.USERS(EMAIL NULLS FIRST) VALUES ('email@example.com')\""));
    ...
    public void testUpdateUser_updatesProvidedFields() {
        ...
        ReflectionTestUtils.setField(request, "bio", "Event organizer and coffee enthusiast.");
        ...
        assertEquals("Event organizer and coffee enthusiast.", result.getBio());
    }
